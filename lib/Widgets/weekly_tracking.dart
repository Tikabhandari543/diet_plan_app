...
class _WeeklyTrackingBarChartState extends State<WeeklyTrackingBarChart> {
 ...
 void _setupRealtimeListener() {
  ...
  _calorieStreamSubscription = FirebaseFirestore.instance
      ...
      .where(FieldPath.documentId,
          isGreaterThanOrEqualTo: DateFormat('yyyyMMdd').format(_selectedWeekStart!),
      ...
      for (var doc in snapshot.docs) {
        try {
          ...
          if (data != null && data.containsKey('consumedCalories')) {
            updatedCalories[dayOfWeek] = (data['consumedCalories'] as num).toDouble();
 ...
 List<BarChartGroupData> _buildBarGroups() {
  ...
  return List.generate(7, (index) {
    ...
    final consumed = _consumedCalories[days[index]] ?? 0;  // Defaults to 0 if not found
      ...
      barRods: [
        BarChartRodData(
          ...
          rodStackItems: [
            ...
            BarChartRodStackItem(0, consumed, Colors.green),  // Consumed calories in green
            BarChartRodStackItem(consumed, widget.goalCalories, Colors.grey),  // Remaining in grey
          ],
  ...
  Widget build(BuildContext context) {
    final weekRangeText = '${DateFormat('dd MMM').format(_selectedWeekStart!)} - '
      ...
      child: Column(
        children: [
          const SizedBox(height: 20),
             ...
             const Text('Weekly Calorie Tracking',
              style: TextStyle(fontSize: 25,
              color: Colors.black
              ),),
               Text('Average calorie goal: ${widget.goalCalories.toStringAsFixed(0) }',
                    ...
                    BarChartData(
                      ...
                      titlesData: FlTitlesData(
                        ...
                        rightTitles: const AxisTitles(
                          sideTitles: SideTitles(showTitles: false), // Disable right vertical titles
                        ),
